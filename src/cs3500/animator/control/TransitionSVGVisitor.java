 ...
 */
public class TransitionSVGVisitor implements TransitionVisitor<String> {
   ...
   */
  public TransitionSVGVisitor(int ticks) {
    this.ticks = ticks;
  }
  ...
  public String visit(MoveTransition move) {
    ...
    item += String.format("    <animate attributeType=\"xml\" begin=\"" + start + "ms\" dur=\""
                    + duration
